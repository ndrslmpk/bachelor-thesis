...
/* 
    Connectors are stand-alone packages that interface with web3-react and 
    manage connections to a single type of Ethereum node or wallet. To give an example
 */
